...
def create_model(width=200):
    ...
    x = Flatten()(pool2)
    dense1 = Dense(256, activation='relu', kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-5, l2=1e-4))(x)
    x = Dropout(0.4)(dense1)
    dense2 = Dense(32, activation='relu', kernel_regularizer=tf.keras.regularizers.l1_l2(l1=1e-5, l2=1e-4))(x)
