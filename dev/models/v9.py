...
def create_model(width=200):
    ...
    conv2_ = Conv2D(64, (3, 10), padding='same',activation='relu')(conv1)
    conv2  = SqueezeExcite(conv2_)
    conv3_ = Conv2D(64, (3, 10), padding='same',activation='relu')(conv2)
    conv3  = SqueezeExcite(conv3_)
    conv4_ = Conv2D(128, (5, 2), padding='valid',activation='relu')(conv3)
    conv4  = SqueezeExcite(conv4_)
    conv5_ = Conv2D(64, (1, 10), padding='valid',activation='relu')(conv4)
