...
def create_model(width=200):
    ...
    conv2_ = Conv2D(64, (3, 5), padding='same',activation='relu')(conv1)
    conv2  = SqueezeExcite(conv2_)
    conv3_ = Conv2D(64, (3, 5), padding='same',activation='relu')(conv2)
    conv3  = SqueezeExcite(conv3_)
    conv4_ = Conv2D(128, (5, 1), padding='valid',activation='relu')(conv3)
