...
def create_model(width=200):
    ...
    conv1_ = Conv2D(64, (5, 10), padding='same',activation='relu')(input_size)
    ...
    pool1  = MaxPooling2D(pool_size=(1, 2))(conv3)
    conv4_ = Conv2D(128, (3, 5), padding='valid',activation='relu')(pool1)
    conv4  = SqueezeExcite(conv4_)
    conv5_ = Conv2D(128, (3, 5), padding='valid',activation='relu')(conv4)
    conv5  = SqueezeExcite(conv5_)
    conv6_ = Conv2D(64, (1, 10), padding='valid',activation='relu')(conv5)
    conv6  = SqueezeExcite(conv6_)
    conv7_ = Conv2D(64, (1, 10), padding='valid',activation='relu')(conv6)
