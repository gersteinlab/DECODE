...
def plot_conv_weights(model, layer):
    ...
    if len(W.shape) == 4:
        ...
        fig.savefig('./figures/classifier.DNase.HepG2.conv_layer.png')
...
X_train, y_train, X_test, y_test = get_DNase("encoded_DNase_HepG2.pickle")
...
plt.savefig('./figures/classifier.DNase.HepG2.accuracy.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('./figures/classifier.DNase.HepG2.loss.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('./figures/classifier.DNase.HepG2.auROC.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('./figures/classifier.DNase.HepG2.auPRC.png')
...
plt.title('ROC curve')
plt.legend(loc='best')
plt.savefig('./figures/classifier.DNase.HepG2.ROC.png')
...
plt.title('PR curve')
plt.legend(loc='best')
plt.savefig('./figures/classifier.DNase.HepG2.PR.png')

print(accuracy_s, auroc_s, auprc_s)

# plot model
plot_model(model, to_file='./figures/classifier.DNase.HepG2.model.png')
