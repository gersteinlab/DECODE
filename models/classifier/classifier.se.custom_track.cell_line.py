...
def get_data(tracks_list):
    track_X_list = list() #[H3K27ac (x, 200), DNase (x, 100), ...] 
...
#         conv1  = Conv2D(128, (1, 10), padding='valid', use_bias=False)(input_size)
#         batch1 = BatchNormalization()(conv1)
#         active1 = Activation('relu')(batch1)
# #        se1 = SqueezeExcite(active1)
        
#         merge_list.append(active1)

#         conv2  = Conv2D(64, (1, 1), padding='valid', use_bias=False)(active1)
#         batch2 = BatchNormalization()(conv2)
#         active2 = Activation('relu')(batch2)
# #        se2 = SqueezeExcite(active2)

#         conv3  = Conv2D(64, (1, 1),padding='valid', use_bias=False)(active2)
#         batch3 = BatchNormalization()(conv3)
#         active3 = Activation('relu')(batch3)
# #        se3 = SqueezeExcite(active3)

#         conv4  = Conv2D(64, (1, 1),padding='valid', use_bias=False)(active3)
#         batch4 = BatchNormalization()(conv4)
#         active4 = Activation('relu')(batch4)
# #        se4 = SqueezeExcite(active4)

#         pool1  = MaxPooling2D(pool_size=(1, 2))(active4)

#         conv5  = Conv2D(64, (1, 1),padding='valid', use_bias=False)(pool1)
#         batch5 = BatchNormalization()(conv5)
#         active5 = Activation('relu')(batch5)
# #        se5 = SqueezeExcite(active5)

#         conv6  = Conv2D(64, (1, 1),padding='valid', use_bias=False)(active5)
#         batch6 = BatchNormalization()(conv6)
#         active6 = Activation('relu')(batch6)
# #        se6 = SqueezeExcite(active6)

#         pool2  = MaxPooling2D(pool_size=(1, 2))(active6)
#         pool2_list.append(pool2)

#         merge_conv2_conv3 = concatenate([active2, active3], axis = -1)
#         merge_list.append(merge_conv2_conv3)

#         merge_conv5_conv6 = concatenate([active5, active6], axis = -1)
#         merge_list.append(merge_conv5_conv6)

#     merge_pool2 = concatenate(pool2_list, axis = -1)

#     x = concatenate(merge_list, axis = 2)
#     x = Flatten()(x)
#     dense1  = Dense(128, use_bias=False)(x)
#     dense_batch1 = BatchNormalization()(dense1)
#     dense_active1 = Activation('relu')(dense_batch1)
#     x = Dropout(0.11)(dense_active1)

#     dense1  = Dense(256, use_bias=False)(x)
#     dense_batch1 = BatchNormalization()(dense1)
#     dense_active1 = Activation('relu')(dense_batch1)
#     x = Dropout(0.47)(dense_active1)

#     dense1  = Dense(32, use_bias=False)(x)
#     dense_batch1 = BatchNormalization()(dense1)
#     dense_active1 = Activation('relu')(dense_batch1)

#     pred_output = Dense(1, activation='sigmoid')(dense_active1)
...
#         input_size = Input(shape=(1, 100, 1))
#         input_list.append(input_size)
#         conv1_ = Conv2D(128, (1, 10),padding='valid')
#         conv1  = SqueezeExcite(conv1_(input_size))
#         merge_list.append(conv1)

#         conv2_ = Conv2D(64, (1, 1), activation='relu',padding='same')
#         conv2  = SqueezeExcite(conv2_(conv1))
#         conv3_ = Conv2D(64, (1, 3), activation='relu',padding='same')
#         conv3  = SqueezeExcite(conv3_(conv2))
#         conv4_ = Conv2D(128, (1, 1), activation='relu',padding='same')
#         conv4  = SqueezeExcite(conv4_(conv3))
#         pool1  = MaxPooling2D(pool_size=(1, 2))(conv4)
#         conv5_ = Conv2D(64, (1, 3), activation='relu',padding='same')
#         conv5  = SqueezeExcite(conv5_(pool1))
#         conv6_ = Conv2D(64, (1, 3), activation='relu',padding='same')
#         conv6  = SqueezeExcite(conv6_(conv5))

#         pool2  = MaxPooling2D(pool_size=(1, 2))(conv6)
#         pool2_list.append(pool2)
...
if __name__ == '__main__':
    ...
    print(np.mean(np.array(accuracy_s)), np.mean(np.array(auroc_list)), np.mean(np.array(auprc_list)))
